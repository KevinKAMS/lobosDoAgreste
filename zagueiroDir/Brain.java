...
class Brain extends Thread implements SensorInput
{
		...
		while( !m_timeOver){
			if(m_memory.isEmpty()){
				...
				if(!posicao)
				{
					...
					{
						System.out.println("Eu sou o zagueiro 1 e cheguei no meu destino");
							posicao = true;
					}
				}
				else
				{
					...
					else if(ball != null && ball.m_distance < 30 && ball.m_distance > 0.7)
					{
    ...
    {
    	m_agent.move(-0.7*52.5, 34-0.65*68.0);
    }
