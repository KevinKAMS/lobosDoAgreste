...
class Brain extends Thread implements SensorInput
{
    ...
    public void run(){
		...
		while( !m_timeOver){
			if(m_memory.isEmpty()){
				...
				object = m_memory.getObject("flag c b");
				...
				if(!posicao)
				{
					if (object == null)
					{
						...
						System.out.println("Eu sou o Meia 3 e cheguei no meu destino");
						posicao = true;
					}	//Meia
				}
				else
				{
					...
					else if(ball != null && ball.m_distance > 0.7 && ball.m_distance <= 21)
					{
					...
					{    
					    ...
					    {
					    	m_agent.kick(flagBot.m_distance + 40, flagBot.m_direction);
					    	m_memory.clearInfo();
					    	chutei++;
					    }
					    else
    ...
    {
    	m_agent.move(-0.1*52.5, 34-0.2*68.0);	//Meia		
    }
