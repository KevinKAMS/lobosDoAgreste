...
class Brain extends Thread implements SensorInput
{
    ...
    public void entrarEmPosicao(){
		if (flag == null)
		{
			...
			System.out.println("Eu sou o Lateral 2 e cheguei no meu destino");
				posicao = true;
		}
    }
    ...
    public void rotina(){
		...
		else if(ball != null && ball.m_distance > 0.7 && ball.m_distance <= 22)
		{
    ...
    {
    	m_agent.move(-0.4*52.5, 34-0.4*68.0);	//Voleiro
    }
