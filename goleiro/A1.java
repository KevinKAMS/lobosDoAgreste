...
//
//***************************************************************************
class A1 implements SendCommand
{
    //===========================================================================
	...
	try
	    ...
	    {
		System.err.println("");
		System.err.println("USAGE: A1 [-parameter value]");
		System.err.println("");
		...
		System.err.println("    team        team_name    A1");
		System.err.println("");
		System.err.println("    Example:");
		System.err.println("      A1 -host www.host.com -port 6000 -team Poland");
		System.err.println("    or");
		System.err.println("      A1 -host 193.117.005.223");
		return;
	    }

	A1 player = new A1(InetAddress.getByName(hostName),
				     port, team);
    ...
    public A1(InetAddress host, int port, String team) 
    ...
    public void got(double direction)
    {
